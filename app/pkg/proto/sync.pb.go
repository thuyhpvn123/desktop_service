...
var file_sync_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x08,
...
var file_sync_proto_goTypes = []interface{}{
	...
	nil,                      // 1: sync.SyncAccoutStates.StorageDataEntry
}
var file_sync_proto_depIdxs = []int32{
	1, // 0: sync.SyncAccoutStates.StorageData:type_name -> sync.SyncAccoutStates.StorageDataEntry
